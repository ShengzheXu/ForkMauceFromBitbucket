    ...
    def run(self):
        ...
        while not job_queue.empty():
            try:
                ...
                [exe, log_filename, statistics_filename] = job_queue.get(block=False)
                print("[" + self.name + "] Now running: " + " ".join(exe) + " " + str(datetime.datetime.now()))
                ...
                print("[" + self.name + "] Done. Took " + total_time + " seconds.")
                with open(statistics_filename, "w") as statistics_file:
                    statistics_file.write(str(end-start))
